library(enviMass)
setwd("C:/Users/ptrainor/Dropbox (NMSU Advanced)/Patrick/ProducedWater/EnviMassProcessing")

# Import profile data from enviMass results:
load_profileList("./results/profileList_pos")
profileList_pos
...
# Internal standards:
load("./results/screening/res_IS_pos_screen")
load("./results/screening/results_screen_IS_pos")
...
save(peaks, profs, profInfo, iSTDDF, file = "./../enviMassOutput_20200721.RData")
